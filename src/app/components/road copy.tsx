...
const RoadmapNode = ({ node }: { node: NodeType }) => {
  ...
  return (
    <div className={/*flex*/ ` items-start relative ml-4 mt-1 ${isThirdLevelParent ? '' : 'flex-col '} `}>
      <div
        onClick={handleClick}
      ...
      {node.
        children.length > 0 && (
          ...
          <div
            className={`${!toggle && isThirdLevelParent ? 'invisible ' : 'visible'} relative  ml-4  flex items-center  ${isThirdLevelParent ? 'flex-row items-center' : 'mt-6 flex-col items-start gap-8 '}`}
          >
...
export default function RoadmapPage() {
  ...
  return (
    <main className="min-h-screen bg-white pt-8">
      ...
      <div className="flex flex-col gap-16 items-start m-4 mb-10">
